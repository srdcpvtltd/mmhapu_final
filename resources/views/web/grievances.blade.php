    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/') }}">MMHAPU Website</a>
                </li>
            </ul>
        </div>
    </nav>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group field-jiform-email required">
                                                    ...
                                                    @error('email')
                                                        <label for="" class="text-danger"> {{ $message }}
                                                        </label>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="department" required>
                                                        ...
                                                        <option value="Islamic Studies">Department of Islamic Studies
                                                        </option>
                                                        <option value="English">Department of English</option>
                                                        <option value="Management">Department of Management</option>
                                                        <option value="Journalism">Department of Journalism & Mass
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="category" required>
                                                ...
                                                <option value="Journals/Literature">Journals/Literature</option>
