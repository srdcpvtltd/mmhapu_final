                        ...
                        <div id="logo">
                            <a href="frontend/index">
                                <img class="rotate-image" src="{{ asset('web/images/logo.jpeg') }}"
                                    alt="rotate logo" />
                                <h4 class="text-logo orange-text"> मौलाना मज़हरुल हक़ अरबी & फ़ारसी
                                    विश्वविद्यालय<br>مولانا مظہر الحق عربی و فارسی یونیورسٹی<br>MAULANA MAZHARUL HAQUE ARABIC & PERSIAN UNIVERSITY</h4>
