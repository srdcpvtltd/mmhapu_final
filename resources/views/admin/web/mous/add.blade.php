            ...
            <form action="{{ route('admin.mous.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="institute" placeholder="Enter Name Of The Institute" required>
                    </div>
                    <div class="col-lg-12 mb-3">
                        <label for="intitution" class="form-label">Collaborative Department In The University<span style="color: red">*</span></label>
                        <input type="text" class="form-control" name="collaborative" placeholder="Enter Collaborative Department In The University" required>
                    </div>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input type="date" class="form-control" name="dated" placeholder="Enter Dated/ Year" required>
                    </div>
                </div>
                <div class="mb-3">
