        ...
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a href="index.php">Home </a> <span class="lnr lnr-arrow-right"></span> <a
                        ...
                        class="orange-text">Attendance</a></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-sm-9 col-md-9 col-xs-12">
                <div class="page-title">
                    <h2><span>List of </span>Attendance</h2>
                </div>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapse{{ $title->id }}"
                                                    ...
                                                    <div class="accordion-body">
                                                        <ul>
                                                            @foreach ($attendance->where('title_id', $title->id) as $record)
                                                                <li><i class="fa fa-arrow-circle-right orange-text"
                                                                        aria-hidden="true"></i>
                                                                    <a
                                                                        href="{{ asset('uploads/attendance/' . $record->file) }}">
                                                                        {{ $record->name }} </a>
                                                                </li>
                                                            @endforeach
                                                        </ul>
