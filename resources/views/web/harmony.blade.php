                    ...
                    <div class="detials">
                        <ul class="custom-list-style text-justify">
                            @foreach ($harmony as $data)
                                <li class="mb-10"><i class="fa fa-check"></i>{{ $data->name }}<span>&nbsp;<a href="{{ asset('uploads/harmony/' . $data->file) }}" class="round-rectangle">Click to View</a></span>
                            @endforeach
                        </ul>
                    </div>
                </div>
